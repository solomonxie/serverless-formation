...
def parse_arn(arn: str) -> dict:
    ...
    Layer: arn:aws:lambda:us-east-1:12345:layer:myapp-lambdalayer:1
    StepFunc: arn:aws:states:us-east-1:12345:stateMachine:myapp-stepfunc-task
    S3: arn:aws:s3:::my-poc-bucket
    EventBridge: arn:aws:events:us-east-1:123123123:rule/weekly-cleanup-job
    Role: arn:aws:iam::12345:role/myapp-role-ro-task
    Policy: arn:aws:iam::12345:policy/myapp-policy-lambda-general
    ...
    API Gateway: arn:aws:apigateway:us-east-1:lambda:path/2015-03-31/functions/arn:aws:lambda:us-east-1:123123123:function:prod-green-myapp-lambda-launch_task/invocations
    """  # NOQA
    info = {}
    parts = str(arn).split(':')
